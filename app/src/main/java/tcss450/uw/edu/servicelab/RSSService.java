...
//            }
//            Log.d(TAG, mResult);
//            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this).setSmallIcon(android.R.drawable.bottom_bar).setContentTitle("StackFlow RSS").setContentText("RSS Updated");
...
//    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        public static void setServiceAlarm (Context context,boolean isOn){
            ...
            if (isOn) {
                alarmManager.setInexactRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP, 10, POLL_INTERVAL, pendingIntent);
            } else {
